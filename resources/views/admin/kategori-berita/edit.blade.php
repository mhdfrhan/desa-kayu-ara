    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Edit informasi kategori berita</p>
            </div>
            ...
            <form action="{{ route('admin.kategori-berita.update', $kategoriBerita) }}" method="POST" class="space-y-6">
                ...
                <div class="px-6 py-4 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama" id="nama" value="{{ old('nama', $kategoriBerita->nama) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="slug" id="slug" value="{{ old('slug', $kategoriBerita->slug) }}"
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="3"
                            ...
                            placeholder="Masukkan deskripsi kategori">{{ old('deskripsi', $kategoriBerita->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-4">
                            <input type="color" name="warna" id="warna"
                                value="{{ old('warna', $kategoriBerita->warna) }}"
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                            ...
                            @foreach ($icons as $iconClass => $iconName)
                                <div class="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:border-green-500 transition-colors icon-option {{ $kategoriBerita->icon == $iconClass ? 'border-green-500 bg-green-50' : '' }}"
                                    data-icon="{{ $iconClass }}">
                    ...
                    <div>
                        ...
                        <input type="number" name="urutan" id="urutan"
                            value="{{ old('urutan', $kategoriBerita->urutan) }}" min="0"
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="aktif" id="aktif" value="1"
                            {{ old('aktif', $kategoriBerita->aktif) ? 'checked' : '' }}
