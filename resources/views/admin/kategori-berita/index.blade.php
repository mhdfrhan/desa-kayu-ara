                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <div class="text-2xl font-semibold text-gray-900">{{ $kategoriBerita->total() }}</div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <div class="text-2xl font-semibold text-gray-900">
                                {{ $kategoriBerita->where('aktif', true)->count() }}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <div class="text-2xl font-semibold text-gray-900">
                                {{ $kategoriBerita->where('aktif', false)->count() }}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <div class="text-2xl font-semibold text-gray-900">{{ $kategoriBerita->sum('berita_count') }}
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end space-x-2">
                                            <a href="{{ route('admin.kategori-berita.show', $item) }}"
                                                class="text-blue-600 hover:text-blue-900 transition-colors"
                                                title="Lihat Detail">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('admin.kategori-berita.edit', $item) }}"
