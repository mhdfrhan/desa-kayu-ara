    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Kelola galeri foto desa</p>
            </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <div class="text-2xl font-semibold text-gray-900">{{ $galeri->total() }}</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <div class="text-sm font-medium text-gray-500">Galeri Aktif</div>
                            <div class="text-2xl font-semibold text-gray-900">
                                {{ $galeri->where('aktif', true)->count() }}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <div class="text-2xl font-semibold text-gray-900">
                                {{ $galeri->where('featured', true)->count() }}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <div class="text-2xl font-semibold text-gray-900">{{ $galeri->sum('likes') }}</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white shadow-sm rounded-lg border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-medium text-gray-900">Filter Galeri</h3>
            </div>
            <div class="px-6 py-4">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        <label for="search_filter" class="block text-sm font-medium text-gray-700 mb-2">Cari Galeri</label>
                        <input type="text" id="search_filter" placeholder="Cari berdasarkan judul galeri..."
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white shadow-sm rounded-lg border border-gray-200">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-16 w-16">
                                                @if ($item->gambar)
                                                    <img src="{{ asset('assets/img/galeri/' . $item->gambar) }}"
                                                        alt="{{ $item->judul }}" class="h-16 w-16 object-cover rounded-lg">
                                                @else
                                                    <div
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm">
                                            <span
                                                ...
                                                <i class="fas fa-heart mr-1"></i>{{ $item->likes }} likes
                                            </span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="text-gray-500 mb-6">Mulai dengan menambahkan galeri pertama</p>
                    <a href="{{ route('admin.galeri.create') }}">
                        <x-primary-button>
                            <i class="fas fa-plus mr-2"></i>
