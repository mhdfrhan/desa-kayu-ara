...
@section('title', 'Tambah Sambutan Kepala Desa')
@section('page-title', 'Tambah Sambutan Kepala Desa')
...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Tambah Sambutan Kepala Desa</h1>
                <p class="mt-1 text-sm text-gray-600">Tambahkan sambutan kepala desa baru</p>
            </div>
                ...
                <div class="px-6 py-4 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="konten_lengkap" id="konten_lengkap" rows="8"
                            ...
                            placeholder="Masukkan sambutan lengkap kepala desa" required>{{ old('konten_lengkap') }}</textarea>
