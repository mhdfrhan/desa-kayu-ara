...
@section('title', 'Tambah Sambutan Penghulu Kampung')
@section('page-title', 'Tambah Sambutan Penghulu Kampung')
...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Tambah Sambutan Penghulu Kampung</h1>
                <p class="mt-1 text-sm text-gray-600">Tambahkan sambutan Penghulu Kampung baru</p>
            </div>
        ...
        <div class="bg-white shadow-sm rounded-lg border border-gray-200">
            <form action="{{ route('admin.sambutan.store') }}" method="POST" class="space-y-6">
                @csrf
                        ...
                        <select name="struktur_organisasi_id" id="struktur_organisasi_id"
                            ...
                            @foreach ($kepalaDesa as $kepala)
                                <option value="{{ $kepala->id }}"
                                    {{ old('struktur_organisasi_id') == $kepala->id ? 'selected' : '' }}>
                ...
                <div class="px-6 py-4 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="sambutan" id="sambutan" rows="4"
                            ...
                            placeholder="Masukkan sambutan singkat yang akan ditampilkan di halaman utama" required>{{ old('sambutan') }}</textarea>
                        @error('sambutan')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <textarea name="quote" id="quote" rows="3"
                            ...
                            placeholder="Masukkan quote atau kata-kata inspirasi (opsional)">{{ old('quote') }}</textarea>
                        @error('quote')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <textarea name="konten_lengkap" id="konten_lengkap" rows="8"
                            ...
                            placeholder="Masukkan sambutan lengkap Penghulu Kampung" required>{{ old('konten_lengkap') }}</textarea>
                ...
                <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 rounded-b-lg">
                    <div class="flex items-center justify-end space-x-3">
                        ...
                        <x-primary-button type="submit" :disabled="$kepalaDesa->isEmpty()">
