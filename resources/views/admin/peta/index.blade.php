...
@section('page-title', 'Manajemen Peta')
...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Manajemen Peta</h1>
                <p class="mt-1 text-sm text-gray-600">Kelola lokasi dan tempat penting di peta desa</p>
            </div>
            <a href="{{ route('admin.peta.create') }}">
                <x-primary-button>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">{{ $totalPeta }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">{{ $petaAktif }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-600">Peta Interaktif</p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex flex-col md:flex-row gap-4">
                <div class="flex-1">
                    ...
                    <input type="text" id="search" placeholder="Cari berdasarkan judul atau alamat..."
                        ...
                        @forelse ($peta as $item)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <div class="text-xs text-gray-500">Zoom: {{ $item->zoom_level }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-2">
                                        <a href="{{ route('admin.peta.show', $item) }}"
                                            class="text-blue-600 hover:text-blue-900 transition-colors">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.peta.edit', $item) }}"
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    <div class="text-gray-500">
                                        ...
                                        <p class="text-sm">Mulai dengan menambahkan lokasi pertama</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
            ...
            <div class="mt-3 text-center">
                ...
                <div class="mt-2 px-7 py-3">
                    <p class="text-sm text-gray-500">
                        Apakah Anda yakin ingin menghapus lokasi "<span id="petaTitle" class="font-semibold"></span>"?
                    </p>
...
@push('scripts')
    <script>
        function toggleStatus(petaId) {
            fetch(`/admin/peta/${petaId}/toggle-status`, {
                    method: 'PATCH',
                    headers: {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        alert('Terjadi kesalahan saat mengubah status lokasi');
                    }
                })
                .catch(error => {
        ...
        function confirmDelete(petaId, petaTitle) {
            document.getElementById('petaTitle').textContent = petaTitle;
            document.getElementById('deleteForm').action = `/admin/peta/${petaId}`;
