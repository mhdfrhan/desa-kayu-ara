    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Tambahkan banner baru untuk ditampilkan di halaman utama</p>
            </div>
                ...
                <div class="px-6 py-4 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="4"
                            ...
                            placeholder="Masukkan deskripsi banner" required>{{ old('deskripsi') }}</textarea>
                        @error('deskripsi')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" name="tombol_teks" id="tombol_teks" value="{{ old('tombol_teks') }}"
                    ...
                    <div>
                        ...
                        <input type="url" name="tombol_link" id="tombol_link" value="{{ old('tombol_link') }}"
