...
@section('title', 'Tambah Data Administrasi Penduduk')
@section('page-title', 'Tambah Data Administrasi Penduduk')
...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Tambah Data Administrasi Penduduk</h1>
                <p class="mt-1 text-sm text-gray-600">Tambahkan data administrasi dan statistik penduduk baru</p>
            </div>
        ...
        <div class="bg-white shadow-sm rounded-lg border border-gray-200">
            <form action="{{ route('admin.administrasi.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="px-6 py-4 space-y-6">
                    ...
                    <div>
                        ...
                        <select name="jenis" id="jenis"
                            ...
                            <option value="total_penduduk" {{ old('jenis') == 'total_penduduk' ? 'selected' : '' }}>Total
                                Penduduk</option>
                            <option value="kepala_keluarga" {{ old('jenis') == 'kepala_keluarga' ? 'selected' : '' }}>Kepala
                                Keluarga</option>
                            <option value="penduduk_sementara" {{ old('jenis') == 'penduduk_sementara' ? 'selected' : '' }}>
                                Penduduk Sementara</option>
                            <option value="laki_laki" {{ old('jenis') == 'laki_laki' ? 'selected' : '' }}>Laki-Laki</option>
                            <option value="perempuan" {{ old('jenis') == 'perempuan' ? 'selected' : '' }}>Perempuan</option>
                            <option value="mutasi_penduduk" {{ old('jenis') == 'mutasi_penduduk' ? 'selected' : '' }}>Mutasi
                                Penduduk</option>
                        </select>
                        @error('jenis')
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="4"
                            ...
                            placeholder="Masukkan deskripsi lengkap tentang data ini" required>{{ old('deskripsi') }}</textarea>
                        @error('deskripsi')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
