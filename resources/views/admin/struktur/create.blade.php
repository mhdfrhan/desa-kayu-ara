...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Tambah Struktur Organisasi</h1>
                <p class="mt-1 text-sm text-gray-600">Tambahkan anggota struktur organisasi baru</p>
            </div>
                ...
                <div class="px-6 py-4 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi_tugas" id="deskripsi_tugas" rows="4"
                            ...
                            placeholder="Jelaskan tugas dan tanggung jawab jabatan ini" required>{{ old('deskripsi_tugas') }}</textarea>
                    ...
                    <div>
                        ...
                        <select name="warna_badge" id="warna_badge"
                            ...
                            <option value="green" {{ old('warna_badge') == 'green' ? 'selected' : '' }}>Hijau</option>
                            <option value="blue" {{ old('warna_badge') == 'blue' ? 'selected' : '' }}>Biru</option>
                            <option value="yellow" {{ old('warna_badge') == 'yellow' ? 'selected' : '' }}>Kuning</option>
                            <option value="red" {{ old('warna_badge') == 'red' ? 'selected' : '' }}>Merah</option>
                            <option value="gray" {{ old('warna_badge') == 'gray' ? 'selected' : '' }}>Abu-abu</option>
                        </select>
                        @error('warna_badge')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="number" name="urutan" id="urutan" value="{{ old('urutan', 0) }}" min="1"
