...
@section('page-title', 'Kelola Kategori Galeri')
...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Kelola Kategori Galeri</h1>
                <p class="mt-1 text-sm text-gray-600">Kelola kategori untuk galeri foto</p>
            </div>
            <div class="mt-4 sm:mt-0">
                <a href="{{ route('admin.kategori-galeri.create') }}">
                    <x-primary-button>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <div class="text-2xl font-semibold text-gray-900">{{ $kategoriGaleri->total() }}</div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <div class="text-2xl font-semibold text-gray-900">
                                {{ $kategoriGaleri->where('aktif', true)->count() }}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <div class="text-2xl font-semibold text-gray-900">
                                {{ $kategoriGaleri->where('aktif', false)->count() }}</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <div class="text-sm font-medium text-gray-500">Total Galeri</div>
                            <div class="text-2xl font-semibold text-gray-900">{{ $kategoriGaleri->sum('galeri_count') }}
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white shadow-sm rounded-lg border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-medium text-gray-900">Daftar Kategori Galeri</h3>
            </div>
            ...
            @if ($kategoriGaleri->count() > 0)
                            ...
                            @foreach ($kategoriGaleri as $kategori)
                                <tr class="hover:bg-gray-50 transition-colors">
                                        ...
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                <div class="h-10 w-10 rounded-lg flex items-center justify-center"
                                                    style="background-color: {{ $kategori->warna }}20;">
                                                    @if ($kategori->icon)
                                                        <i class="{{ $kategori->icon }} text-lg"
                                                            style="color: {{ $kategori->warna }};"></i>
                                                    @else
                                            ...
                                            <div class="ml-4">
                                                ...
                                                <div class="text-sm text-gray-500">
                                                    <div class="flex items-center space-x-2">
                                                        ...
                                                        <span class="text-xs font-mono">{{ $kategori->warna }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900 font-mono">{{ $kategori->slug }}</div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900">
                                            {{ $kategori->deskripsi ? Str::limit($kategori->deskripsi, 50) : 'Tidak ada deskripsi' }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm">
                                            <span
                                                ...
                                                <i class="fas fa-images mr-1"></i>{{ $kategori->galeri_count }} galeri
                                            </span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <button onclick="toggleStatus({{ $kategori->id }})"
                                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium cursor-pointer transition-colors
                                                {{ $kategori->aktif
                                                    ? 'bg-green-100 text-green-800 hover:bg-green-200'
                                                    : 'bg-gray-100 text-gray-800 hover:bg-gray-200' }}">
                                            <i
                                                class="fas fa-{{ $kategori->aktif ? 'check-circle' : 'times-circle' }} mr-1"></i>
                                            {{ $kategori->aktif ? 'Aktif' : 'Nonaktif' }}
                                        </button>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end space-x-2">
                                            <a href="{{ route('admin.kategori-galeri.show', $kategori) }}"
                                                class="text-blue-600 hover:text-blue-900 transition-colors"
                                                title="Lihat Detail">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('admin.kategori-galeri.edit', $kategori) }}"
                ...
                <!-- Pagination -->
                @if ($kategoriGaleri->hasPages())
                    <div class="px-6 py-4 border-t border-gray-200">
                        {{ $kategoriGaleri->links() }}
                    </div>
                @endif
            @else
                <div class="text-center py-12">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-2">Belum ada kategori galeri</h3>
