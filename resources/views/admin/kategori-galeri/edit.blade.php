...
@section('page-title', 'Edit Kategori Galeri')
    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Edit informasi kategori galeri</p>
            </div>
        ...
        <div class="bg-white shadow-sm rounded-lg border border-gray-200">
            <form action="{{ route('admin.kategori-galeri.update', $kategoriGaleri) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="px-6 py-4 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama" id="nama" value="{{ old('nama', $kategoriGaleri->nama) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="slug" id="slug" value="{{ old('slug', $kategoriGaleri->slug) }}"
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="3"
                            ...
                            placeholder="Masukkan deskripsi kategori">{{ old('deskripsi', $kategoriGaleri->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-3">
                            <input type="color" name="warna" id="warna"
                                value="{{ old('warna', $kategoriGaleri->warna) }}"
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-6 gap-2 mb-3">
                            ...
                            @foreach ($icons as $icon)
                                <button type="button" onclick="selectIcon('{{ $icon }}')"
                                    class="icon-option p-3 border border-gray-300 rounded-lg hover:border-green-500 hover:bg-green-50 transition-colors text-center {{ old('icon', $kategoriGaleri->icon) == $icon ? 'border-green-500 bg-green-50' : '' }}"
                                    data-icon="{{ $icon }}">
                        ...
                        <input type="text" name="icon" id="icon"
                            value="{{ old('icon', $kategoriGaleri->icon) }}"
                    ...
                    <div>
                        ...
                        <input type="number" name="urutan" id="urutan"
                            value="{{ old('urutan', $kategoriGaleri->urutan) }}" min="0"
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="aktif" id="aktif" value="1"
                            {{ old('aktif', $kategoriGaleri->aktif) ? 'checked' : '' }}
