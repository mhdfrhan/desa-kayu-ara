...
@section('title', 'Edit Data Chart')
@section('page-title', 'Edit Data Chart')
...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Edit Data Chart</h1>
                <p class="mt-1 text-sm text-gray-600">Edit data untuk visualisasi chart statistik</p>
            </div>
        ...
        <div class="bg-white shadow-sm rounded-lg border border-gray-200">
            <form action="{{ route('admin.data-chart.update', $dataChart) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="px-6 py-4 space-y-6">
                        ...
                        <select name="chart_id" id="chart_id" required
                            ...
                            @foreach ($charts as $chart)
                                <option value="{{ $chart->id }}"
                                    {{ old('chart_id', $dataChart->chart_id) == $chart->id ? 'selected' : '' }}>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="label" id="label"
                                value="{{ old('label', $dataChart->label) }}"
                        ...
                        <div>
                            ...
                            <input type="number" name="nilai" id="nilai"
                                value="{{ old('nilai', $dataChart->nilai) }}" min="0" step="0.01"
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="4"
                            ...
                            placeholder="Masukkan deskripsi lengkap tentang data ini">{{ old('deskripsi', $dataChart->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="flex items-center space-x-3">
                                <input type="color" name="warna" id="warna"
                                    value="{{ old('warna', $dataChart->warna ?? '#10B981') }}"
                        ...
                        <div>
                            ...
                            <input type="number" name="urutan" id="urutan"
                                value="{{ old('urutan', $dataChart->urutan) }}" min="0"
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center">
                            <input type="checkbox" name="aktif" id="aktif" value="1"
                                {{ old('aktif', $dataChart->aktif) ? 'checked' : '' }}
