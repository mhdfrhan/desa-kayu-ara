    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Kelola berita untuk ditampilkan di website desa</p>
            </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <div class="text-2xl font-semibold text-gray-900">{{ $berita->total() }}</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <div class="text-sm font-medium text-gray-500">Berita Aktif</div>
                            <div class="text-2xl font-semibold text-gray-900">{{ $berita->where('aktif', true)->count() }}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <div class="text-sm font-medium text-gray-500">Berita Featured</div>
                            <div class="text-2xl font-semibold text-gray-900">
                                {{ $berita->where('featured', true)->count() }}</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <div class="text-sm font-medium text-gray-500">Berita Nonaktif</div>
                            <div class="text-2xl font-semibold text-gray-900">{{ $berita->where('aktif', false)->count() }}
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm">
                                            ...
                                            <div class="text-gray-500">{{ Str::limit($item->ringkasan, 80) }}</div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm">
                                            ...
                                            <button onclick="toggleFeatured({{ $item->id }})"
                                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium cursor-pointer transition-colors
                                                    {{ $item->featured
                                                        ...
                                                        : 'bg-gray-100 text-gray-800 hover:bg-gray-200' }}">
                                                <i class="fas fa-{{ $item->featured ? 'star' : 'star-o' }} mr-1"></i>
