    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Edit informasi kategori produk</p>
            </div>
        ...
        <div class="bg-white shadow-sm rounded-lg border border-gray-200">
            <form action="{{ route('admin.kategori-produk.update', $kategoriProduk) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="px-6 py-4 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama" id="nama" value="{{ old('nama', $kategoriProduk->nama) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="slug" id="slug" value="{{ old('slug', $kategoriProduk->slug) }}"
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-4">
                            <input type="color" name="warna" id="warna"
                                value="{{ old('warna', $kategoriProduk->warna) }}"
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                            ...
                            @foreach ($icons as $iconClass => $iconName)
                                <div class="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:border-green-500 transition-colors icon-option {{ $kategoriProduk->icon == $iconClass ? 'border-green-500 bg-green-50' : '' }}"
                                    data-icon="{{ $iconClass }}">
                        ...
                        <input type="text" name="icon" id="icon"
                            value="{{ old('icon', $kategoriProduk->icon) }}"
                            ...
                            placeholder="fas fa-box" readonly>
                        @error('icon')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">
                            Pilih icon untuk kategori ini.
                    ...
                    <div>
                        ...
                        <input type="number" name="urutan" id="urutan"
                            value="{{ old('urutan', $kategoriProduk->urutan) }}" min="0"
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="aktif" id="aktif" value="1"
                            {{ old('aktif', $kategoriProduk->aktif) ? 'checked' : '' }}
